...
def corrupt_mnist() -> tuple[torch.utils.data.Dataset, torch.utils.data.Dataset]:
    ...
    train_images = torch.load("data/processed/train_images.pt", map_location=device)
    train_target = torch.load("data/processed/train_target.pt", map_location=device)
    test_images = torch.load("data/processed/test_images.pt", map_location=device)
    test_target = torch.load("data/processed/test_target.pt", map_location=device)
